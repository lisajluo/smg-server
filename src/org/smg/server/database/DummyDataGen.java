...
public class DummyDataGen {
  ...
  public static void addPlayer(){
    Entity player = new Entity("Player",1234);
    ...
    player.setProperty("playerId", 1234);
    player.setProperty("accessSignature", "HJJIIKKSJF");    
    datastore.put(player);
    
    Entity player2 = new Entity("Player",5678);
    ...
    player2.setProperty("playerId", 5678);
    player2.setProperty("accessSignature", "ISUDJKAKKA");    
    datastore.put(player2);
  }
  
  public static void addGame(){
    Entity game = new Entity("Game",12233);
    game.setProperty("gameId", 12233);;
